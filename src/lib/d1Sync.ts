...
async function collectLocalSyncData(aiSessions: AISession[]): Promise<SyncData> {
  const [
    studyRecords,
    questionNotes,
...
async function applySyncData(backup: SyncData): Promise<void> {
  await Promise.all([
